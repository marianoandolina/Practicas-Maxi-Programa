...
# r = n1 * n1 * n1
# print(f"El resultado del numero elevado al cubo es {r}")
...
# an = int(input("Ingresa el año de tu nacimiento: "))
# e = aa - an
# print(f"Tu edad es {e} años")
...
# k = int(input("Ingrese la distancia entre las ciudades: "))
# v = int(input("Ingrese la velocidad promedio de viaje: "))
# t= k / v
# print(f"El tiempo estimados de viaje es de {t} hs.")
...
# tf= int(input("Ingrese el total facturado por la empresa: "))
# c= (5 * tf) / 100
# sueldo= 15000 + c
# print(f"El sueldo final incluida la comision este mes es de {sueldo}")
...
# promedio= (n1 + n2 + n3) / 3
# print(f"El promedio de las 3 notas ingresadas es de {promedio}")
...
# mt= int(input("Ingrese los metros cuadrados totales del predio: "))
# mc= int(input("Ingrese los metros cubiertos totales del predio: "))

# pc= (mc*100) / mt
# md= mt - mc
# pd= (md * 100) / mt
# print(f"El promedio de los metros cubiertos es de {pc}")
# print(f"El promedio de los metros descubiertos es de {pd}")
...
# mt= int(input("Ingresa el monto total de la compra: "))
# precio_final= mt * 0.85
# print(f"El precio a pagar luego de aplicado el descuento es de {precio_final}")
...
# hombres= int(input("Ingrese la cantidad de hombres que asisten a la clase: "))
# mujeres= int(input("Ingrese la cantidad de mujeres que asisten a la clase: "))
# total_alumnos= hombres + mujeres

# porcentaje_hombres= (hombres * 100) / total_alumnos
# porcentaje_mujeres= (mujeres * 100) / total_alumnos

# print(f"El porcentaje de hombres en la clase es de {porcentaje_hombres}")
# print(f"El porcentaje de mujeres en la clase es de {porcentaje_mujeres}")
